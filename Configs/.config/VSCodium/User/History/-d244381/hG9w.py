...
# Use a relative path or environment variable for production environments
MAIN_PATH = "E:/Python/" 
...
@contextmanager
def get_db_connection(db_name: str = "EKTM_HAM"):
    """
    Context manager to handle SQL Server connections and ensure they close correctly.
    """
    config_path = f"{MAIN_PATH}/data/password/always_on_sql.json"
    try:
        ...
        logger_instance.error(f"Credentials file not found at {config_path}")
        raise
