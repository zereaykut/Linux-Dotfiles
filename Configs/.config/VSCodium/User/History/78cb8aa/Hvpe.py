...
def main():
    ...
    # 4B) Convergence at pressure levels
    ...
    Convergence_900  = compute_convergence_level(900)   # may not exist -> stays NaN with warning
    ...
    ds_out = xr.Dataset(
        data_vars={
            ...
            "Convergence_900": (("time", "latitude", "longitude"), Convergence_900),
        ...
        attrs={
            "notes": (
                ...
                "Convergence computed as -div(u,v) at 1000/950/900/850 hPa (if level exists) and at 10m if u10/v10 exist."
            )
        },
    )
