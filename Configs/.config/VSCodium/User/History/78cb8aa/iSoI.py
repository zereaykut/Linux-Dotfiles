...
def main():
    ...
    # ------------------------------------------------------------
    # 4) Convergence_10m & Convergence_850m (loop over time; still reasonably fast)
    # ------------------------------------------------------------
    ...
    ds_out = xr.Dataset(
        ...
        attrs={
            "notes": (
                ...
                "Convergence computed via -div(u10,v10). LI/SI left as NaN unless you implement hotspot-only."
            )
        },
    )
