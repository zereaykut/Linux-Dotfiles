...
# Load the .env file for credentials like EVDS_API_KEY
load_dotenv()

# Set ROOT_DIR to the directory containing app.py
# __file__ is src/utils.py, so .parent.parent moves up to the root
ROOT_DIR = Path(__file__).parent.parent

# Always save to the data/ directory inside the project root
