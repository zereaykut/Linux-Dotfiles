...
# NOT: Veriler Copernicus Interactive Cloud Atlas platformundan alınmıştır: https://atlas.climate.copernicus.eu/atlas
...
METRICS_LIST = [
    {
        "file_name": "t-CMIP6_timeseries.csv",
        "title": "Ortalama Sıcaklık Değişimi",
        "unit": "°C",
        "color": "#e31a1c" # Kırmızı
    },
    {
    ...
    {
        "file_name": "sdii-CMIP6_timeseries.csv",
        "title": "Yağış Şiddeti (SDII)",
        "unit": "mm/gün",
        "color": "#33a02c" # Yeşil
    },
    {
        ...
        "unit": "kg/m2",
        "color": "#ff7f00" # Turuncu/Kahve
    },
    {
        "file_name": "prsn-CMIP5_timeseries.csv",
        "title": "Kar Yağışı Değişimi",
        "unit": "mm/gün",
        "color": "#6a3d9a" # Mor
    }
]
