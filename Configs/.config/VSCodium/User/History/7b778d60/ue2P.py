...
# 1. Resolve the project root (the directory containing 'src')
# __file__ is '.../project/src/__init__.py'
# .parent is '.../project/src/'
# .parent.parent is '.../project/'
PROJECT_ROOT = Path(__file__).resolve().parent.parent
LOG_DIR = PROJECT_ROOT / "logs"

# 2. Ensure logs directory exists at the project root
LOG_DIR.mkdir(parents=True, exist_ok=True)

# 3. Create the full absolute path for the log file
