...
from src.report import plot_generation_regplot, plot_dual_axis_ts
...
def main() -> None:
    ...
    df_generation = data_prep("data/generation.csv", "Generation", "Date")

    for loc in data_list:
        df_projection = data_prep(f"data/extracted-projection-data/{loc}", skiprows=52)
