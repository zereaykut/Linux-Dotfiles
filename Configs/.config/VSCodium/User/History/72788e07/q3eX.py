...
def main() -> None:
    ...
    # --- Model Data ---
    df_model_test = model_data(df_generation, df_projection, "Date", "2023-01-01", "2025-12-31")
    df_model_prediction = model_data(df_generation, df_projection, "Date", "2023-01-01", "2028-12-31")

    # --- Model Test ---
    model_lr(df_model_test, "Generation", train_start="2023-01-01", train_end="2024-12-31", pred_start="2025-01-01", pred_end="2025-12-31", test=True)
    model_lrf(df_model_test, "Generation", train_start="2023-01-01", train_end="2024-12-31", pred_start="2025-01-01", pred_end="2025-12-31", test=True)

    # --- Model Prediction ---
    model_lr(df_model_prediction, "Generation", train_start="2023-01-01", train_end="2025-12-31", pred_start="2028-01-01", pred_end="2028-12-31")
    model_lrf(df_model_prediction, "Generation", train_start="2023-01-01", train_end="2025-12-31", pred_start="2028-01-01", pred_end="2028-12-31")
