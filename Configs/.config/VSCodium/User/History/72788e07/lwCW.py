...
def main() -> None:
    ...
    model_lr(df_model_prediction, "Generation", train_start="2023-01-01", train_end="2025-12-31", pred_start="2026-01-01", pred_end="2028-12-31")
    model_rf(df_model_prediction, "Generation", train_start="2023-01-01", train_end="2025-12-31", pred_start="2026-01-01", pred_end="2028-12-31")
