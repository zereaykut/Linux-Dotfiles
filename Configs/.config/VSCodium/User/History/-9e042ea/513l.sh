...
$SOURCE_PATH/reset-xdg-portal.sh

# XDPH environment updates
$SOURCE_PATH/xdph_environment_updates.sh

# Top bas/panel (Waybar)
$SOURCE_PATH/start-top-bar.sh

# Wallpaper daemon
$SOURCE_PATH/start-wallpaper-daemon.sh

# Clipboard manager
$SOURCE_PATH/start_app.sh "wl-paste --watch cliphist store"

# Notification daemon
$SOURCE_PATH/start_app.sh "swaync"
