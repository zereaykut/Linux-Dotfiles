...
def main():
    ...
    ds_t2m = standardize_coords(open_grib([DATA / "era5_t2m_2023_2024_2025.grib"], chunks=chunks2d))
    ds_d2m = standardize_coords(open_grib([DATA / "era5_d2m_2023_2024_2025.grib"], chunks=chunks2d))
    ds_u10 = standardize_coords(open_grib([DATA / "era5_u10m_2023_2024_2025.grib"], chunks=chunks2d))
    ds_v10 = standardize_coords(open_grib([DATA / "era5_v10m_2023_2024_2025.grib"], chunks=chunks2d))
