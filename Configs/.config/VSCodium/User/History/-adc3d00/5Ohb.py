...
def main():
    ...
    cai.to_dataset(name="CAI").to_netcdf(OUTPUT / "cai_2023_2025.nc")
    ...
    fig1.savefig(OUTPUT / "cai_tracks_example.png", dpi=150)

    fig2 = plot_track_density(cai_sub, tracks, title="Cu-object track density (subset)")
    fig2.savefig(OUTPUT / "track_density.png", dpi=150)
