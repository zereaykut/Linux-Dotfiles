...
def main():
    DATA = Path("./data_grib")      # <- your GRIB folder
    ...
    # (Now you have 100/300/400 + 200/500/700 + 850/950/1000 for ALL years)
    # -------------------------
    ...
    # (Now you have 100/300/400 + 850/950/1000 for ALL years)
    # NOTE: You do NOT list q_200_500_700 anymore, so we only include the files you have.
    # -------------------------
    for year in (2023, 2024, 2025):
        build_zarr(
            name=f"q_pl_{year}",
