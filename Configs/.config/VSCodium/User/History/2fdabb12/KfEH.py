...
class EpiasTransparencyerServices:
    ...
    def real_time_generation(self, tgt: str, start_date: str, end_date: str, real_time_generation_id:Union[int,None]=None) -> requests.Response:
        """Gercek Zamanli Uretim (GZUP) Servisi"""
        payload = self._format_dates(start_date, end_date)
        payload["powerPlantId"] = real_time_generation_id
