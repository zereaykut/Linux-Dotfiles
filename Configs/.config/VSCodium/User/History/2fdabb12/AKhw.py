...
class EpiasTransparencyerServices:
    ...
    def _post_request(self, endpoint: str, tgt: str, payload: dict) -> requests.Response:
        """Helper to centralize POST requests."""
    ...
    def mcp(self, tgt: str, start_date: str, end_date: str) -> requests.Response:
        ...
        return self._post_request("v1/markets/dam/data/mcp", tgt, payload)
